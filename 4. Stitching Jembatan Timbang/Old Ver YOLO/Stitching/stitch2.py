        ...
        while True:
            ...
            if boxes.size > 0 and clss is not None:
                ...
                for box, cls, mask in zip(boxes, clss, masks):
                    ...
                    # confidence = result[0].boxes.conf[int(cls)]  # Get confidence score
                    ...
                    if name in [
                        ...
                        if current_contours:
                            ...
                            ratioW = (min_distance_m * (-0.0012)) + 6.4944
                            ratioH = (min_distance_m * (-0.0013)) + 6.6671
                            realW = w / ratioW
                            realH = h / ratioH

                            # Prepare the text to display
                            text = f"W: {realW}, H: {realH}, D: {min_distance_m:.2f} m"  # Add distance to text
